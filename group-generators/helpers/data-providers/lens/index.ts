...
export class LensProvider extends GraphQLProvider {
  ...
  public async exploreProfiles(context: any, cursor: number): Promise<ExploreProfileType> {
    const cursorFormatted = "{\"offset\":"+cursor+"}";
    console.log('cursorFormatted');
    console.log(cursorFormatted);
    return await exploreProfilesQuery(this, cursorFormatted);
  }
