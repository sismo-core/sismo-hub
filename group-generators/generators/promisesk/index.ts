...
const generator: GroupGenerator = {
  ...
  dependsOn: ["ethereum-power-users","sismo-early-users","sismo-masquerade-lens-followers","gitcoin-grants-rounds-donors","proof-of-attendance-main-events","ens-supporters","sismo-contributors"],
