...
const generator: GroupGenerator = {
  ...
  dependsOn: ["sismo-early-users","sismo-masquerade-lens-followers","ethereum-power-users","proof-of-humanity","gitcoin-grants-rounds-donors","twitter-ethereum-influencers","sismo-contributors","rhinofi-power-users","ens-supporters"],
  ...
  generate: async (context: GenerationContext, groupStore: GroupStore): Promise<GroupWithData[]> => {
    ...
    const rhinofiPowerUsersData7 = dataOperators.Map(
