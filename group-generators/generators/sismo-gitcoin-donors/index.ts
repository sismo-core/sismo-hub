...
import {
  BigQueryProvider,
  SupportedNetwork,
} from "@group-generators/helpers/data-providers/big-query";
import {
  ValueType,
  Tags,
  FetchedData,
    ...
    return [
      {
        ...
        description: "Data Group of all Sismo Gitcoin donors",
        specs: "Contains all addresses that donated to Sismo through Gitcoin",
        data,
