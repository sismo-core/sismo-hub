...
const generator: GroupGenerator = {
  ...
  dependsOn: ["ethereum-power-users","sismo-early-users","sismo-masquerade-lens-followers","proof-of-humanity","gitcoin-grants-rounds-donors","proof-of-attendance-main-events","ens-supporters","twitter-ethereum-influencers","rhinofi-power-users","sismo-contributors"],
