...
export const playgroundFlows: Flow[] = [
  ...
  },
  {
    ...
    subtitle: "Prove you are a Degen NFT Trader.",
    onboardingDescription: "You have claimed the NFT Degen ZK Badge!",
    ctaLabel: "Explore WIW",
    ctaUrl: "<https://wiw.io>",
    congratulationTexts: ["You have claimed the NFT Degen ZK Badge!"],
  },
  {
    path: "crypto-memento",
    attester: hydraS1SimpleAttester.name,
    ...
    attesterType: "hydra-s1",
    badgesCollection: hydraS1SimpleBadges,
    badgesInternalCollectionsIds: [202],
    title: "WIW",
    logoUrl: "https://static.wiw.io/image/logo.png",
    subtitle: "Prove you have experienced crypto historical moment.",
    onboardingDescription: "You have claimed the Crypto Memento ZK Badge — Vol.1!",
    ctaLabel: "Explore WIW",
    ctaUrl: "<https://wiw.io>",
    congratulationTexts: ["You have claimed the Crypto Memento ZK Badge — Vol.1!"],
  },
  {
