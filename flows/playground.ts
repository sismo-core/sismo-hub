...
export const playgroundFlows: Flow[] = [
  ...
  },
  {
    ...
    logoUrl: null,
    subtitle: "Attest your contribution on LilNouns's PropLot",
    onboardingDescription: "Become an active participant on PropLot",
    ctaLabel: "Become an Active Participant",
    ctaUrl: "<https://lilnouns.wtf/ideas>",
    congratulationTexts: ["Keep contributing cool ideas on PropLot!"],
  },
  {
    path: "lilnouns-proplot-voters",
    attester: hydraS1SimpleAttester.name,
    network: Network.Polygon,
    attesterType: "hydra-s1",
    badgesCollection: hydraS1SimpleBadges,
    badgesInternalCollectionsIds: [28],
    title: "LilNouns Proplot Voters",
    logoUrl: null,
    subtitle: "Attest your vote on LilNouns's PropLot",
    onboardingDescription: "Become an active participant on PropLot",
    ctaLabel: "Become an Active Participant",
    ctaUrl: "<https://lilnouns.wtf/ideas>",
    congratulationTexts: ["Keep supporting good ideas on PropLot!"],
  },
];
