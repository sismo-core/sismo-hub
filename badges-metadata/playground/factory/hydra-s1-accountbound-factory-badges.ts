...
export const factoryBadges = [
  ...
  {
    internalCollectionId: 2024929,
    networks: [
      Network.Polygon
    ],
    name: "IDDQDid ZK Badge",
    description: "The badge ZK belongs to the community, gives the right to vote.",
    image: "iddqdid.svg",
    groupGeneratorName: "iddqdid",
    publicContacts: [
      {
        type: "twitter",
        contact: "@0110010010"
