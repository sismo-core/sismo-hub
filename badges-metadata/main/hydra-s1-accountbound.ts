    ...
    badges: [
        ...
        },
        {
            ...
            curatedAttributes: {
                [BadgeAttribute.PRIVACY]: BadgeAttributeValue.VERY_HIGH,
                [BadgeAttribute.TRUSTLESSNESS]: BadgeAttributeValue.HIGH,
                [BadgeAttribute.SYBIL_RESISTANCE]:
                    BadgeAttributeValue.VERY_HIGH,
            },
            links: [
                {
                    logoUrl: '',
        ...
        },
        {
            ...
            description:
                'ZK Badge owned by the most followed ens names on Twitter',
        ...
        },
        {
            ...
            description:
                'The player cheated five games in row at gamejutsu.app',
        ...
        },
        {
            ...
            description:
                '[tutorial] ZK Badge received by early contributors of ENS',
        ...
        },
        {
            ...
            description:
                'ZK Badge owned by Sismo Team for testing Ziki Pass on Goerli',
        ...
        },
        {
            ...
            description:
                'ZK Badge proving that user verified his e-mail address',
            image: 'zohal-KYC.svg',
            groupSnapshot: {
                groupName: 'zohal-KYC',
            },
