...
export default new Attester({
  ...
  attestationsCollections: [
    ...
    new AttestationsCollection({
      groupsFetcher: async () => [await Group.store.latest("sismo-diggers")],
      badge: new Badge({
    ...
    new AttestationsCollection({
      groupsFetcher: async () => [await Group.store.latest("sismo-citizens")],
      badge: new Badge({
    ...
    new AttestationsCollection({
      groupsFetcher: async () => [], // [await Group.store.latest("sismo-guests")],
      badge: new Badge({
    ...
    new AttestationsCollection({
      groupsFetcher: async () => [
        await Group.store.latest("sismo-masquerade-lens-followers"),
      ],
      badge: new Badge({
    ...
    new AttestationsCollection({
      groupsFetcher: async () => [
        await Group.store.latest("ethereum-power-users"),
      ],
      badge: new Badge({
